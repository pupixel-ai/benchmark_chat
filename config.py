...
CRITIC_PROVIDER = os.getenv("CRITIC_PROVIDER", "openrouter").strip().lower()
CRITIC_MODEL = os.getenv("CRITIC_MODEL", "anthropic/claude-opus-4.6").strip()
PROFILE_LLM_PROVIDER = os.getenv("PROFILE_LLM_PROVIDER", "").strip().lower()
PROFILE_LLM_MODEL = os.getenv("PROFILE_LLM_MODEL", "deepseek/deepseek-chat-v3-0324").strip()
