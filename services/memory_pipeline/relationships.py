...
from .types import MemoryState, RelationshipDossier, RelationshipTypeSpec
...
def _apply_status_correction(dossier: RelationshipDossier, relationship: Relationship) -> Relationship:
...
def _has_strong_relationship_signal(dossier: RelationshipDossier, relationship: Relationship) -> bool:
