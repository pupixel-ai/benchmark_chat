...
class VLMAnalyzer:
    ...
    def __init__(self, cache_path: str = VLM_CACHE_PATH, task_version: str = ""):
        self.provider = "openrouter" if task_version in {TASK_VERSION_V0323, TASK_VERSION_V0325, TASK_VERSION_V0327_EXP, TASK_VERSION_V0327_DB} else VLM_PROVIDER
        ...
        elif task_version in {TASK_VERSION_V0325, TASK_VERSION_V0327_EXP, TASK_VERSION_V0327_DB}:
