...
class LLMProcessor:
    ...
    def __init__(self, task_version: str = DEFAULT_TASK_VERSION):
        ...
        self.provider = "openrouter" if self.task_version in {TASK_VERSION_V0323, TASK_VERSION_V0325, TASK_VERSION_V0327_EXP, TASK_VERSION_V0327_DB} else LLM_PROVIDER
        self.relationship_follows_main_llm = RELATIONSHIP_FOLLOWS_MAIN_LLM
        if self.task_version in {TASK_VERSION_V0323, TASK_VERSION_V0325, TASK_VERSION_V0327_EXP, TASK_VERSION_V0327_DB}:
        ...
        elif self.task_version in {TASK_VERSION_V0325, TASK_VERSION_V0327_EXP, TASK_VERSION_V0327_DB}:
