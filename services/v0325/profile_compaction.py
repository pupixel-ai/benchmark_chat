...
def compact_lp3_profile(lp3_profile: Any) -> Dict[str, Any]:
    ...
    if "events" in lp3_profile:
        payload["events"] = copy.deepcopy(lp3_profile.get("events") or [])
    if "relationships" in lp3_profile:
        payload["relationships"] = copy.deepcopy(lp3_profile.get("relationships") or [])
    if "debug" in lp3_profile:
        payload["debug"] = copy.deepcopy(lp3_profile.get("debug") or {})
