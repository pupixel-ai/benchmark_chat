...
from .consistency_checker import build_consistency_report

from .evidence_utils import build_evidence_payload, extract_ids_from_refs, flatten_ref_buckets
from .profile_agent import ProfileAgent
from .profile_tools import extract_metadata_evidence
...
def build_profile_context(state: MemoryState) -> Dict[str, Any]:
    ...
    metadata_bundle = extract_metadata_evidence(
        {
    ...
    return {
        ...
        "social_media_available": bool(metadata_bundle.get("has_social_media_evidence")),
        "resolved_facts": {},
    }
